...
namespace TankJoyPlayer
{
    ...
    void PlayerEntityHandler::Init()
    {
        ...
        m_HandlerId = Safir::Dob::Typesystem::HandlerId(L"Consoden::TankJoyPlayer(" + mPlayerName + L")"); //::GenerateRandom();
    ...
    void PlayerEntityHandler::NewGameStateCB(int tankId, Safir::Dob::Typesystem::InstanceId gameId)
    {
        CreateJoystick(tankId, gameId);
    }

    void PlayerEntityHandler::UpdateGameStateCB()
    {
        MoveJoystick();
    }
    ...
    void PlayerEntityHandler::CreateJoystick(int tankId, Safir::Dob::Typesystem::InstanceId gameId)
    {
        ...
        m_JoystickEntityHandlerPtr->Init(m_PlayerId, gameId); 
    }

    void PlayerEntityHandler::MoveJoystick()
    {
