...
private:
    ...
    {
        m_joystick(moveDirection, towerDirection, fire, dropMine,false,false);
    }
    ...
    {
        m_joystick(moveDirection, towerDirection, fire, dropMine, fireLaser,deploySmoke);
    }
