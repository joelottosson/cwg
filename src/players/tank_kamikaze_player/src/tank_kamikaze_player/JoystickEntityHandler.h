...
namespace TankKamikazePlayer
{
    ...
    public:
         ...
         */
        void Init(Safir::Dob::Typesystem::InstanceId playerId, const Consoden::TankGame::GameStatePtr game_ptr, Safir::Dob::Typesystem::InstanceId gameId);
    ...
    private:
        ...
        void CreateJoystick(int tankId, Safir::Dob::Typesystem::InstanceId playerId, const Consoden::TankGame::GameStatePtr game_ptr, Safir::Dob::Typesystem::InstanceId gameId);
        void DeleteJoystick();
