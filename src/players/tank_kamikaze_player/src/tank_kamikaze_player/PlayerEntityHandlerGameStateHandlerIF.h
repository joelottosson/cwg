...
namespace TankKamikazePlayer
{
    ...
    public:
        ...
        virtual void NewGameStateCB(int tankId, const Consoden::TankGame::GameStatePtr game_ptr, Safir::Dob::Typesystem::InstanceId gameId) = 0;
        virtual void UpdateGameStateCB(const Consoden::TankGame::GameStatePtr) = 0;
