...
namespace TankKamikazePlayer
{
    ...
    public:
        ...
        void NewGameStateCB(int tankId, const Consoden::TankGame::GameStatePtr game_ptr, Safir::Dob::Typesystem::InstanceId gameId);
        void UpdateGameStateCB(const Consoden::TankGame::GameStatePtr game_ptr);
    ...
    private:
        ...
        void CreatePlayer();
        void CreateJoystick(int tankId, const Consoden::TankGame::GameStatePtr game_ptr, Safir::Dob::Typesystem::InstanceId gameId);
        void MoveJoystick(const Consoden::TankGame::GameStatePtr game_ptr);
        void DeleteJoystick();
